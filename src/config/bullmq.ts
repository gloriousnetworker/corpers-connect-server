 ...
 *
 * Railway Redis uses rediss:// (TLS). The `tls` option must be set explicitly;
 * otherwise the worker connects over plain TCP and the handshake fails silently,
 * leaving all jobs stuck in the queue forever.
 */
